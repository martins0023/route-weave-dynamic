...
const Signup = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    toast({
      ...
      description: "Welcome to MobilityMesh! Your account has been created.",
    });
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Enter your information to get started with MobilityMesh
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    I agree to the{" "}
                    <Link to="/terms" className="text-transit-teal hover:underline">
                      terms of service
                    </Link>
                    {" "}and{" "}
                    <Link to="/privacy" className="text-transit-teal hover:underline">
                      privacy policy
                    </Link>
                  </label>
                </div>
          ...
          <CardFooter>
            <div className="text-center w-full">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/login" className="text-transit-teal hover:underline">
                  Log in
                </Link>
              </p>
            </div>
